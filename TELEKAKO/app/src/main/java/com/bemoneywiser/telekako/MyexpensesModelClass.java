...
public class MyexpensesModelClass {
    ...
    public MyexpensesModelClass(String itemTitle, String itemDesc, String dateText, String itemAmount,String startingAmount, String startingdate,int progress,String micurrency,String miCurrency2){
